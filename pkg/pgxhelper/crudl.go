...
func CreateReturning[T any](ctx context.Context, querier Querier, stmt squirrel.InsertBuilder) (T, error) {
	var defaultT T
	...
	if err := querier.QueryRow(ctx, sql, args...).Scan(&defaultT); err != nil {
		return defaultT, err
	}
